...
<div class="mstrLargeIconView">
 ...
 <web:then>
	  ...
	  <tr><td>
	   <web:ifFeature name="accessibility"><web:then>
	    <img class="a508" <web:resource type="style" attribute="src" name="mstr/images/dktpVersion.gif"/> <web:descriptor attribute="alt" key="mstrWeb.2564" desc="Version information..." /> <web:descriptor attribute="title" key="mstrWeb.10" desc="Search" /> />
	   </web:then><web:else>
	    <web:urlEvent eventID="com.microstrategy.web.app.beans.EnumServletEvents.WebEventOpenAbout" >
	     <span class="mstrIcon" id="mstrIconVersion" <web:descriptor attribute="title" key="mstrWeb.2564" desc="Version information..." /> ></span>
	    </web:urlEvent>
	   </web:else></web:ifFeature>
	   </td><td class="mstrLargeIconViewItemText">
	   <div class="mstrLargeIconViewItemName">
	    <web:urlEvent eventID="com.microstrategy.web.app.beans.EnumServletEvents.WebEventOpenAbout">
	     <web:descriptor key="mstrWeb.2564" desc="Version information..." />
	    </web:urlEvent>
	   </div>
	   <div class="mstrLargeIconViewItemDescription"></div>
	  </td></tr></table>
	  </web:dynTableCell>
  </web:then>
  <web:else>
