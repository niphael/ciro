...
--%>
 <a href="mstrIPA" id='mstrStarburst' class="mstrLink" style="left:50px;top:0px;" <web:descriptor attribute="TITLE" key="mstrWeb.8841" desc="Projects" />>
 
 Cloud Operations Manager
 </a>
<span class="mstrShortcut" style="left:200px;position:absolute;">
