...
<web:resource   type="custom-style" name="@_Interface:style/mstrWeb.css" />
<web:resource   type="custom-style" name="@_Interface:style/mstr/layoutDefault.css" />
<web:resource   type="custom-style" name="@_Interface:style/mstr/schemeDefault.css" />
