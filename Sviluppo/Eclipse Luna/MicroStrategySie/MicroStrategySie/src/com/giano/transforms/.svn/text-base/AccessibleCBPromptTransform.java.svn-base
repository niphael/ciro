...
public class AccessibleCBPromptTransform extends AbstractTransform{
	...
	public void transform(Transformable data, MarkupOutput out) throws ClassCastException {	
		...
		if (elements == null || elements.size() == 0) {
			...
			try {
				...
				for (int i=0;i<elements.size();i++) {	
					...
					out.append("	  <tr style=\"\">\n");											
					out.append("         <td class=\"w20 alignLeft\"><input "+sChecked+" name=\"answer"+sPosPrompt+"\" id=\""+sLabel+"\" value=\""+sValore+"\" type=\"checkbox\"></td>\n");
		...
		out.append("      <tr style=\"\">\n");	
		out.append("            <td class=\"w20\"><input value=\"1\" name=\"answerOptions"+sPosPrompt+"\" id=\"answerOptions"+sPosPrompt+"\" type=\"hidden\"></td>\n");						
