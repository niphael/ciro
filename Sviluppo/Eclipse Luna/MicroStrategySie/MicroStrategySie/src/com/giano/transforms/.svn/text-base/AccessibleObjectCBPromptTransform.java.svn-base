...
public class AccessibleObjectCBPromptTransform extends AbstractTransform{
	...
	public void transform(Transformable data, MarkupOutput out) throws ClassCastException {
		...
		out.append("	  </tr>");*/	
		out.append("	  <tr>");	
		out.append("		<td class=\"w5 alignLeft\" colspan=\"2\"><p class=\"sezione\">"+objPrompt.getMeaning()+"</p></td>");	
		out.append("	  </tr>");	
		out.append("	  <tr>");	
		out.append("         <th class=\"w20 alignLeft\"><p class=\"sezione\">Selezione</p></th>");
		out.append("         <th class=\"w90 alignLeft\" nowrap><p class=\"sezione\">"+objPrompt.getName()+sPromptMandatory+"</p></th>");			                               
		out.append("      </tr>");	 
