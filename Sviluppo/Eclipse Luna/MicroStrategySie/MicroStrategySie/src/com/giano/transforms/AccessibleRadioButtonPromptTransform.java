 ...
 *
 */
public class AccessibleRadioButtonPromptTransform  extends AbstractTransform{
	public String getDescription() {
		// TODO Auto-generated method stub
		return "Accessible Radio Button Prompt";
	}
	...
	public void transform(Transformable data, MarkupOutput out) throws ClassCastException {
		...
		out.append("	  </tr>");*/	
		out.append("	  <tr>\n");	
		out.append("		<td class=\"w5 alignLeft\" colspan=\"2\"><p class=\"sezione\">"+elemPrompt.getMeaning()+"</p></td>\n");	
		out.append("	  </tr>\n");	
		out.append("	  <tr>\n");	
		out.append("         <th class=\"w20 alignLeft\"><p class=\"sezione\">Selezione</p></th>\n");
		out.append("         <th class=\"w90 alignLeft\" nowrap><p class=\"sezione\">"+elemPrompt.getName()+sPromptMandatory+"</p></th>\n");				                              
		out.append("      </tr>\n");	                                        
		...
		if (elements == null || elements.size() == 0) {
			...
			try {
				...
				for (int i=0;i<elements.size();i++) {	
					...
					out.append("	  <tr style=\"\">\n");											
					out.append("         <td class=\"w20 alignLeft\"><input "+sChecked+" name=\"answer"+sPosPrompt+"\" id=\""+sLabel+"\" value=\""+sValore+"\" type=\"radio\"></td>\n");
					out.append("		 <td class=\"w90 alignLeft\"><label for=\""+sLabel+"\">"+sLabel+"</label></td>\n");
					out.append("      </tr>\n");
		...
		out.append("      <tr style=\"\">\n");	
		out.append("            <td class=\"w20\"><input value=\"\" name=\"answerOptions"+sPosPrompt+"\" id=\"answerOptions"+sPosPrompt+"\" type=\"hidden\"></td>\n");						
		out.append("		      <td class=\"w90\"><input value=\"2\" name=\"answerFormat"+sPosPrompt+"\" id=\"answerFormat"+sPosPrompt+"\" type=\"hidden\"></td>\n");						          
		out.append("	  </tr>\n");	      
		out.append("      </tbody>\n");	
		out.append("</table>&nbsp;\n");	
