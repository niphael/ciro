                ...
                <table cellspacing="0" cellpadding="0">
	                <tr>
	                    ...
	                    <td style="white-space:nowrap;">
	                     <input id="intervalValue" maxlength="5" name="intervalValue" value="" onfocus="getObj('dateSubType_1').checked='checked'" onkeyup="updateOptions(this);" size="1" type="text" dt="2" />                    
