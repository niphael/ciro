...
<script type="text/javascript"> 
          ...
          mstrConfig = {
		      ...
		      mstrDescs: <web:bundleDescriptor name="mojo-coreui,android-app-large-hosted"/>
          };
...
<web:resource type="jsbundle" bundleName="android-app-large-hosted" /> 
...
<script type="text/javascript">     
       ...
       mstrApp = new mstrmojo.MobileApp({
           ...
           viewFactory: new mstrmojo.android.large.ViewFactory(),
           firstGoBack: true,
       ...
       if (window.history.pushState) {
           ...
           // Override onpoststate to back up our app.
