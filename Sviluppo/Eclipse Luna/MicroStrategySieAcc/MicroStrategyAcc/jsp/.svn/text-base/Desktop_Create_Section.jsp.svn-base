 ...
 <web:ifFeature name="dhtml;web-import-data"><web:then>
  <web:dynTableCell>
   <table class="mstrLargeIconViewItem" cellspacing="0">
    <tr><td>
    <web:ifFeature name="accessibility"><web:then>
     <img <web:resource type="style" attribute="src" name="mstr/images/dktpImportData.gif"/> <web:descriptor attribute="alt" key="mstrWeb.7972" desc="Import Data" />/>
    </web:then><web:else>
		<web:ifFeature type="systemPreference" name="enableQB"><web:then>
			<web:urlEvent eventID="com.microstrategy.web.app.beans.EnumServletEvents.WebEventOpenImportWizardEntryPage">
          		<web:eventArgument name="com.microstrategy.web.app.beans.EnumServletEvents.WebEventArgumentIsNew" value="true" />
          		<span class="mstrIcon" id="mstrIconImportData" <web:descriptor attribute="title" key="mstrWeb.7972" desc="Import Data" />></span>
        	</web:urlEvent>
        </web:then><web:else>
        	<web:urlEvent eventID="com.microstrategy.web.app.beans.EnumServletEvents.WebEventOpenImportWizard">
          		<web:eventArgument name="com.microstrategy.web.app.beans.EnumServletEvents.WebEventArgumentIsNew" value="true" />
          		<span class="mstrIcon" id="mstrIconImportData" <web:descriptor attribute="title" key="mstrWeb.7972" desc="Import Data" />></span>
        	</web:urlEvent>
        </web:else></web:ifFeature>	
    ...
    <div class="mstrLargeIconViewItemName">
    	<web:ifFeature type="systemPreference" name="enableQB" ><web:then>
			<web:urlEvent eventID="com.microstrategy.web.app.beans.EnumServletEvents.WebEventOpenImportWizardEntryPage">
            	<web:eventArgument name="com.microstrategy.web.app.beans.EnumServletEvents.WebEventArgumentIsNew" value="true" />
	      		<web:descriptor desc="Import Data" key="mstrWeb.7972"/>
     		</web:urlEvent>
     	</web:then><web:else>	
     		<web:urlEvent eventID="com.microstrategy.web.app.beans.EnumServletEvents.WebEventOpenImportWizard">
            	<web:eventArgument name="com.microstrategy.web.app.beans.EnumServletEvents.WebEventArgumentIsNew" value="true" />
