<%
 /****
  * Filter_Path.jsp
  * This file includes the content of the Path section for pages that display filter editing page.
...
<web:displayGuiComponent name="filter_path" isContainer="false"/>
