  ...
  <web:then>
    <web:ifFeature name="i-frame">
      <web:then>
        ...
        <script language="javascript">if (typeof(microstrategy) != 'undefined') microstrategy.registerBone("leftToolbar", (true), { 'ltW' : '<web:value type="browserSetting" name="ltW"/>'});</script>
        <STYLE TYPE="text/css">
        .mstrContent {
          margin-right: 15px;
          overflow: auto;
