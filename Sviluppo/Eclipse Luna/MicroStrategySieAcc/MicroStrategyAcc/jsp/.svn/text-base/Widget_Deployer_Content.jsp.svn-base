                ...
                <table cellpadding="2" border="0" cellspacing="0" width="95%">
                  ...
                  <tr>
                    <td valign="top" colspan="2" class="adminButtonBar">
                      <input type="submit" style="font-weight: bold" name="submit" <web:descriptor attribute="value" key="mstrWeb.5081" desc="Deploy Widget" /> onclick="document.getElementById('resultsDiv').style.display='block';"/>
                      <br>
                    </td>
                  </tr>
                  <tr>
