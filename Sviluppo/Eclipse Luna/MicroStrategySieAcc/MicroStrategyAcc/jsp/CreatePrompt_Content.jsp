...
<div class="mstrPanelTitleButtonBar">
	<a <web:value type="helpUser" attribute="href" name="Creating_prompts.htm"/> target="_new">
    	<img class="mstrIcon-btn mstrIcon-btnHelp" src="../images/1ptrans.gif"  <web:descriptor key="mstrWeb.1143" desc="Help" attribute="title" />/>
	</a>
</div>
