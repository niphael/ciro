                ...
                <TR>
                    ...
                    <TD>
                        <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="2">
                            ...
                            <TR>
                                <TD VALIGN="TOP"><IMG <web:resource attribute="SRC" name="bullet_arrow_right.gif"/> WIDTH="3" HEIGHT="8" ALT="" BORDER="0" />
                                    <span class="mstrStandardHighlighted"><web:descriptor key="mstrWeb.9757" desc="Help Configuration" /></span>
                                </TD>
                            </TR>
