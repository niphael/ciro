...
<%-- Render the instructions for the 'Print Options'. --%>
        ...
        <TD>
            <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="2">
                ...
                <TR>
                    ...
                    <TD WIDTH="3" VALIGN="TOP"><IMG <web:resource attribute="SRC" name="bullet_arrow_right.gif"/> WIDTH="3" HEIGHT="8" ALT="" BORDER="0" /></TD>
                    <TD VALIGN="TOP"><web:descriptor key="mstrWeb.896" desc="Print options enable you to customize the appearance of the report prior to printing." />&nbsp<web:descriptor key="mstrWeb.1098" desc="Click 'Show Printable Version' to show how the report will look when printed." /></TD>
                </TR>
                <TR>
                    <TD><IMG <web:resource attribute="SRC" name="1ptrans.gif"/> WIDTH="13" HEIGHT="1" ALT="" BORDER="0" /></TD>
                    <TD WIDTH="3" VALIGN="TOP"><IMG <web:resource attribute="SRC" name="bullet_arrow_right.gif"/> WIDTH="3" HEIGHT="8" ALT="" BORDER="0" /></TD>
