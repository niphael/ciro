...
<html xmlns:v="urn:schemas-microsoft-com:vml">
      <web:performanceTimer action="initialize"/><web:performanceTimer action="start"/>
<head>
<style>  v\:line { behavior:url(#default#VML); display:inline-block;}
...
<web:clientSideDescriptor IDs = "2,3,2058,2213,2947,3610,4325,4664,4665,5877,6595,8953,9163" />
<%--
...
if(typeof(microstrategy) != 'undefined') {
 ...
 microstrategy.features = {<web:value type="features" name="web-import-data,web-use-sharing-editor"/>};
 ...
 <web:ifFeature type="systemPreference" name="useCookies" value="1"><web:then> <%-- add jsessionid only cookie is not disabled --%>
    microstrategy.sessionId = "<web:connectionValue property="containerSessionId" />"; <%--TQMS 267726 --%>
 </web:then></web:ifFeature>
 //_JSP]
...
--%>
<body class="mstrWeb <web:ifConnectionValue><web:then><web:value type='preference' name='colorTheme' /></web:then><web:else><web:value type='browserSetting' name='colorTheme' /></web:else></web:ifConnectionValue> <web:ifFeature name='page-full-screen-mode'><web:then> mstrFullScreen</web:then></web:ifFeature><web:ifFeature name='dhtml'><web:then> mstrDHTML</web:then><web:else> mstrHTML</web:else></web:ifFeature>
...
<web:ifFeature type="requestKey" name="hiddensections" value="contains:header"><web:else>
	<div class="mstrHeader" id="mstrWeb_shortcutsBar" name="mstrWeb_shortcutsBar" iframe="true">
		<%--
		 ...
		 <jsp:include page="[a page section]" />
		--%>
		<web:ifFeature name="showHeaderBar" type="preference" value="0">
        <web:then>
...
--%>
<iframe id="frameManager" name="frameManager" <web:ifFeature type="browserSetting" name="iframeVisible" value="1"><web:then>style="display: block;z-index: 100;"</web:then></web:ifFeature> <web:value name="servletDeploymentName" type="config" attribute="src"  postContent="?pg=iframeIdle" />></iframe>
<!--"end:iframe"-->
...
<web:scriptlet>
if (typeof(microstrategy) != 'undefined') microstrategy.bonesToRegister.push({id : "divWaitBox", loadCondition : "true",  properties : {'allowCancel':<web:ifTemplateValue property="allow-cancel"><web:then>true</web:then><web:else>false</web:else></web:ifTemplateValue>}});
</web:scriptlet>
<!--end:waitIframe-->
<%--
 Displays a gray area where the wait box will be loaded
--%>
</web:then></web:ifTemplateValue>
<%--
