...
public class AccessibleListBoxPromptTransform  extends AbstractTransform{
	...
	public void transform(Transformable data, MarkupOutput out) throws ClassCastException {
		...
		out.append("<table class=\"w90 alignLeft\" > <tbody>	  <tr>		<td class=\"w5 alignLeft access\" colspan=\"2\"><p class=\"alignLeft sezione\">"+elemPrompt.getMeaning()+"</p></td>	  </tr>");	
		...
		if (elements == null || elements.size() == 0) {
			...
			try {
				...
				out.append("<tr>         <th class=\"w30 alignLeft access\"><p class=\"alignLeft sezione\"><label for=\"answer"+sPosPrompt+"\">"+elemPrompt.getName()+sPromptMandatory+"</label></p></th> <th class=\"w90 alignLeft access\" nowrap><select name=\"answer"+sPosPrompt+"\" id=\"answer"+sPosPrompt+"\">\n");
			...
			out.append("</select></th>      </tr></tbody></table>\n");
			out.append("</p>\n");
		}else{
