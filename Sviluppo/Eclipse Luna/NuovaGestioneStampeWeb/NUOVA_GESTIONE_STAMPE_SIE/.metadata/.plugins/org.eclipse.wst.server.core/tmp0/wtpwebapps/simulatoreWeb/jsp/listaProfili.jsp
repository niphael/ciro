...
<%@ include file="/jsp/include/header.jsp"%>
	<f:form action='<%=request.getContextPath() + WebApplicationConstants.VIEW_DETT_REPORT+ "?metodo=init"%>' modelAttribute="profiliForm"  method="post" >
		...
		<table  class="w100 cornice" >
					<tr>
						...
						<tr>
							...
							<td class="w85">
										<f:select path="codiProfilo"><f:options items="${profiliForm.listProfili}" itemValue="value" itemLabel="label" /></f:select>
