	...
	<table class="w100">
				...
				<table class="w100 cornice">
					...
					<tr>
						<td class="alignTop"><table class="w100" border="0"
								...
								<tr>
									<td class="w15"><label for="descrizione">Destinatario</label></td>
		...
		<tr>
			<td><display:table
					...
					name="${ listaDestinatari }" class="tableRicerca w100" pagesize="8"
					excludedParams="*">
					<display:column property="codice" title="Destinatario"></display:column>
					<display:column property="descrizione" title="Email"></display:column>
