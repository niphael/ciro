	...
	<table class="w100">
				...
				<table class="w100 cornice">
					...
					<tr>
						<td class="alignTop"><table class="w100" border="0"
								...
								<tr>
									<td class="w15"><label for="descrizione">Login Microstrategy</label></td>
		...
		<tr>
			<td><display:table
					...
					name="${ listaLoginMstr }" class="tableRicerca w100" pagesize="8"
					excludedParams="*">
					<display:column property="descrizione" title="Login Microstrategy"></display:column>
