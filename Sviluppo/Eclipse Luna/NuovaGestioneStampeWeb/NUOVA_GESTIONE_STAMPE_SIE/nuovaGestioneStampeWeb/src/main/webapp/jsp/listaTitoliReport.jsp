...
<f:form
	action="<%=request.getContextPath() + WebApplicationConstants.RICERCA_TITOLI_REPORT%>"
	...
	<table class="w100">
				...
				<table class="w100 cornice">
					...
					<tr>
						<td class="alignTop"><table class="w100" border="0"
								...
								<tr>
									<td class="w15"><label for="descrizione">Report</label></td>
		...
		<tr>
			<td><display:table
					requestURI="/ricercaTitoliReport.html?metodo=scorriLista" id="item"
					name="${ listaStampe }" class="tableRicerca w100" pagesize="8"
					excludedParams="*">
					<display:column property="descrizione" title="Report"></display:column>
